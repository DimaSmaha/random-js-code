class Weather {
  constructor() {
    this.apiKey = "0d8b0e7f340840fcb3581337242906";
  }

  async fetchData(city, aqiFlag) {
    const body =
      await fetch(`https://api.weatherapi.com/v1/current.json?key=${this.apiKey}&q=${city}&aqi=${aqiFlag}
  `)
        .then((res) => res.json())
